...
--------------------------------------------------------------------------------
-- ANTI-OVERLAP: Destroy old instances if they exist
--------------------------------------------------------------------------------
if playerGui:FindFirstChild("HyperionServerTuner") then
    playerGui.HyperionServerTuner:Destroy()
end
if playerGui:FindFirstChild("AkaiXDkayServerTuner") then
    playerGui.AkaiXDkayServerTuner:Destroy()
end
...
-- Title Header Top Text (Explicitly branded to Akai-X-Dkay)
...
local function createTabButton(name, iconText, isActive)
    ...
    btn.TextSize = 10
    btn.TextColor3 = isActive and Color3.fromRGB(255, 76, 76) or Color3.fromRGB(110, 125, 150)
    btn.Parent = sidebar
...
masterFrame.BackgroundColor3 = Color3.fromRGB(26, 16, 16)
...
masterStroke.Color = Color3.fromRGB(80, 24, 24)
...
masterLabel.Text = "MASTER LAG-REDUCTION <font color='#ff4c4c'>(ON)</font>"
...
local function createToggleRow(title, desc, stateKey)
    ...
    switchBg.BackgroundColor3 = Color3.fromRGB(255, 76, 76)
